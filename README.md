...
-This lab focusing on OOP structure and how to use lambda for decrease function 
...
├── Cities.csv                # The dataset containing city, country, and temperature data.
 |---- data_processing.py	  # Main Python file containing DataLoader and Table classes
